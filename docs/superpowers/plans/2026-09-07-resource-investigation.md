...
- [x] Verification: fake-client scope/permission/partial-list checks, generated PKI and local TLS server tests, navigation and literal-markup regressions, lab workflow (isolated functional capture; user-verified direct-launch guidance retained). Update usage, roadmap and PR; do not merge.
